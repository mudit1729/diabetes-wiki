...
Navigation hub for the Diabetes Wiki.
...
- [[wiki/medications/semaglutide|Semaglutide]]
- [[wiki/medications/tirzepatide|Tirzepatide]]
- [[wiki/medications/empagliflozin|Empagliflozin]]
- [[wiki/medications/dapagliflozin|Dapagliflozin]]
- [[wiki/medications/metformin|Metformin]]
- [[wiki/medications/basal-insulin|Basal insulin]]
- [[wiki/medications/sulfonylureas|Sulfonylureas]]
- [[wiki/medications/finerenone|Finerenone]]

## Common Clinic Scenarios

- [[wiki/scenarios/overview|Common Clinic Scenarios]]
- [[wiki/scenarios/a1c-9-ckd-albuminuria|A1C 9.2% with CKD and albuminuria]]
- [[wiki/scenarios/t2d-obesity-ascvd|Type 2 diabetes with obesity and ASCVD]]
- [[wiki/scenarios/recurrent-hypoglycemia-on-sulfonylurea|Recurrent hypoglycemia on sulfonylurea]]
- [[wiki/scenarios/older-adult-low-a1c-on-insulin|Older adult with A1C 6.4% on insulin]]
- [[wiki/scenarios/new-insulin-start-primary-care|New insulin start in primary care]]
...
- [[wiki/trials/dcct-edic|DCCT / EDIC]]
- [[wiki/trials/accord-advance-vadt|ACCORD / ADVANCE / VADT]]
- [[wiki/trials/sglt2-cvot-program|SGLT2 CVOT Program]]
- [[wiki/trials/glp1-cvot-program|GLP-1 CVOT Program]]
- [[wiki/trials/flow|FLOW]]

## Status

The wiki has a diabetes-specific scaffold plus hand-authored seed pages. Use **Add** (`/add-paper`) to ingest full source-grounded paper pages into `wiki/sources/papers/{slug}.md`.
